...
public class Transitioned2 : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Start()
    {
        ...
        anim1.Play("title_fade_in");
    }

    private void OnEnable()
    {
        anim2.Play("button1_fade_in");
        anim1.Play("quit_text_fade_in");
    }
